...
@dp.message(F.text.in_(["🎯 Рандом з 3 локацій", "🎯 Рандом з 5 локацій", "🎯 Рандом з 10 локацій"]))
        ...
        async with aiohttp.ClientSession() as session:
            async with session.get(static_map_url) as resp:
                if resp.status == 200:
                    ...
                    await message.answer_photo(types.BufferedInputFile(photo_bytes, filename="route.png"),
